...
namespace StorageService
{
    public class QueueService
    {
        public void AddMessage(string messageText, string queueName)
        {
            ...
            storageAccount = CloudStorageAccount.Parse(StorageService.Properties.Settings.Default
                .AzureStorageServiceConnectionString); //Pode quebrar linha antes do ponto

            // Cliente de serviços de queue
            CloudQueueClient queueClient = storageAccount.CreateCloudQueueClient();

            // Cria um objeto CloudQueue que faz referencia a uma fila específica
        ...
        public string GetMessage(string queueName)
        {
            ...
            // Obtem uma referencia a mensagem
